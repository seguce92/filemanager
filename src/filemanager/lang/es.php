...
return array(
	...
	'File_Permission' => 'Permiso de archivo',
	'File_Permission_Not_Allowed' => 'Changing %s permissions are not allowed.', // %s = files or folders
	'File_Permission_Recursive' => 'Aplicar recursividad?',
	'File_Permission_Wrong_Mode' => "The supplied permission mode is incorrect.",
	'User' => 'Usuario',
	'Group' => 'Grupo',
	'Yes' => 'Yes',
	'No' => 'No',
	'Lang_Not_Found' => 'No se encontro idioma.',
	'Lang_Change' => 'Cambiar idioma',
	'File_Not_Found' => 'No se encontro el archivo buscado.',
	'File_Open_Edit_Not_Allowed' => 'Tu no tienes permisos %s en este archivo.', // %s = open or edit
	'Edit' => 'Edit',
	'Edit_File' => "Editar contenido de archivo",
	'File_Save_OK' => "Archivo guardado exitosamente.",
	'File_Save_Error' => "There was an error while saving the file.",
	'New_File' => 'Nuevo Archivo',
	'No_Extension' => 'Tu debes agregar una extension al archivo.',
	'Valid_Extensions' => 'Extensiones validas: %s', // %s = txt,log etc.
	'Upload_message' => "Arrastre el archivo aqui para subir",
